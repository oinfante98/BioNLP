...
if __name__ == "__main__":
    ...
    #print("   Number of training class RI: {}".format(y_train.count('RI')))
    ...
    #print("   Number of testing class RI: {}".format(y_test.count('RI')))
    ...
    cad=str(args.classifier)+str(args.kernel)+str(args.reduction)+str(args.removeStopWords)+str(args.ngrinitial)+str(args.ngrfinal)+str(args.vectorizer)
    ...
    with open(os.path.join(args.outputReportPath, args.outputReportFile), mode='w', encoding='utf8') as oFile:
        oFile.write(cad+'Best score {}: {}\n'.format(myScorer, myClassifier.best_score_))
        oFile.write(str(theBestClassifier) + '\n')
